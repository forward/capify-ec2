...
Note: There is a pre-release version of Capify-EC2 currently in public testing, you can find it on Rubygems as v1.4.3.pre5 and in Github under the 'rolling_deploy' branch.
